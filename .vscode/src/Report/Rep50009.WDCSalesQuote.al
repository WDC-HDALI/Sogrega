report 50009 "WDC Sales Quote"
{
    /**********************************Documentation*********************
    //WDC01     WDC.HG    09/09/2025        Creation of "sales Invoice" report 
    *********************************************************************/
    RDLCLayout = './.vscode/src/Report/RDLC/SalesQuote.rdl';
    CaptionML = ENU = 'Sales Quote', FRA = 'Devis vente';
    Description = 'Devis vente';
        ...
        dataitem(Header; "Sales Header")
        {
            ...
            begin
                ...
                if "Currency Code" <> '' then begin
                    CurrencyExchangeRate.FindCurrency("Document Date", "Currency Code", 1);
                    CalculatedExchRate :=
                ...
                ;
                MonthTxt := Format(DATE2DMY("Document Date", 2));
