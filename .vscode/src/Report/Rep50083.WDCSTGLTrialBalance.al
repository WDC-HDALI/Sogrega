report 50083 "WDC-ST G/L Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/src/report/RDLC/GLTrialBalance.rdl';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                TLAccountType := "G/L Account"."Account Type".AsInteger(); //FS
                IF (GLAccount2."Account Type" = GLAccount2."Account Type"::Posting) AND (GLAccount2."Income/Balance" = GLAccount2."Income/Balance"::"Balance Sheet")
                THEN BEGIN
                ...
                IF ("G/L Account"."Account Type" = "G/L Account"."Account Type"::Posting) AND ("G/L Account"."Income/Balance" = "G/L Account"."Income/Balance"::"Income Statement") //FS
                THEN BEGIN
    ...
    var
        ...
        DateFilterCalc: Codeunit "WDC DateFilter-Calc";
        FiscalYearFiscalClose: Codeunit "WDC Fiscal Year FiscalClose";
        STFiscalYearFiscalClose: Codeunit "WDC Fiscal Year FiscalClose";
        StartDate: Date;
