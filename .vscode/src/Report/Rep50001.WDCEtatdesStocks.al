report 50001 "WDC Etat des Stocks"
{
    //***********Documentation*****************
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            dataitem(ItemLedgerEntry; "Item Ledger Entry")
            {
                ...
                column(ExternalRef; ExternalRef)
                {
                }
                ...
                begin
                    ...
                    Item.CalcFields("Reference No.");
                    ExternalRef := Item."Reference No.";
                    ...
                    //         DateExp := ItemLedgerEntry4."Expiration Date";P
