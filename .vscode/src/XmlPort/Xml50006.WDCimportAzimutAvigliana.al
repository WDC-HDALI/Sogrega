...
xmlport 50006 "WDC import Azimut Avigliana "
{
    CaptionML = FRA = 'import commande "Azimut Avigliana" ', ENU = 'import "Azimut Avigliana" Order';
    Direction = Import;
    Format = VariableText;
    TextEncoding = UTF8;
    FieldDelimiter = '"';
